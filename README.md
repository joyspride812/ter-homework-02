...
5)standard-v3 не поддерживает cores = 1, мне подойдёт cores = 2
![image](https://github.com/user-attachments/assets/94576d57-e03a-400c-9b22-d9ee205cd51b)
...
3)
preemptible = true Прерываемые виртуальные машины доступны по более низкой цене в сравнении с обычными, достаточны в учебных целях.
  
core_fraction=5 core_fraction - параметр, который определяет процент CPU-ядра, выделяемый виртуальной машине. Чем ниже - тем бюджетнее итоговая стоимость виртуальной машины. Если этого достаточно в учебных целях- зачем платить больше.  
...
![image](https://github.com/user-attachments/assets/f6be15f5-a30c-4c62-9520-79916a554cd3)  
...
3. Примените изменения.
  ...
  Ответ:  
![image](https://github.com/user-attachments/assets/6400b9e9-25c0-4eaf-8aed-8ad88c88197c)
![image](https://github.com/user-attachments/assets/ee72b96e-bd94-426d-aa3a-343e55db802a)  
...
Ответ:  
![image](https://github.com/user-attachments/assets/b348c49b-cf8d-4138-ac7c-8d0e9dedde19)  
...
3. Примените изменения.
  ...
  ![image](https://github.com/user-attachments/assets/ddc80686-a090-4f92-bbb6-addfd08ca4f6)  
...
6. Проверьте terraform plan. Изменений быть не должно.
  ...
  Ответ:  
  ![image](https://github.com/user-attachments/assets/22b03e89-c6dc-4096-be29-87e5e7c5f284)
